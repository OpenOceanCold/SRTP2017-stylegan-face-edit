...
def main():
    ...
    # network_pkl = 'networks/generator_star-stylegan2-config-f.pkl'
    # network_pkl = 'networks/generator_wanghong-stylegan2-config-f.pkl'
    # network_pkl = 'networks/generator_model-stylegan2-config-f.pkl'
